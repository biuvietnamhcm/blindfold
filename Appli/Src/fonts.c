/**
  ******************************************************************************
  * @file    fonts.c
  * @brief   8x8 monospace bitmap font data, ASCII 0x20-0x7E.
  *
  *          Glyphs are the public-domain "font8x8_basic" bitmap font
  *          (IBM/VGA ROM heritage; see github.com/dhepper/font8x8),
  *          transposed here from its native row-major layout into the
  *          column-major, bit0-is-top-pixel layout that SH1106_WriteChar()
  *          expects. Swapped in for the previous hand-rolled glyph set,
  *          whose strokes were broken/illegible on a 1-bit 128x64 OLED --
  *          there's no anti-aliasing to hide a wrong pixel there, so the
  *          glyph shapes need to be right, not just roughly letter-shaped.
  ******************************************************************************
  */
#include "fonts.h"
